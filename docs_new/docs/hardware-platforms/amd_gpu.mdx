...
- **Sampling backend:** Use `--sampling-backend pytorch`.
...
| `Qwen/Qwen3.5-4B` | 4B | Qwen3.5 hybrid (24 MLA + 8 full attn) | ~27s | ✅ 2.5s first token |
...
> on RDNA3 with certain model architectures.
